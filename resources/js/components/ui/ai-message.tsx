  ...
  return (
    ...
    >
      ...
      <div className={cn("flex min-w-0 flex-col gap-1", isUser && "items-end")}>
        <div
          className={cn(
            "w-fit max-w-2xl text-sm leading-relaxed",
            bubble && "rounded-2xl p-4 sm:p-5 shadow-sm transition-all",
            bubble && isUser && "rounded-tr-none bg-gradient-to-r from-primary via-blue-600 to-primary/95 text-primary-foreground shadow-md",
            bubble && !isUser && "rounded-tl-none bg-card/90 border border-border/80 text-foreground shadow-lg backdrop-blur-md",
