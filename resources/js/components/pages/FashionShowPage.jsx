...
const fallback =
    'https://images.unsplash.com/photo-1594932224030-940af6602380?q=80&w=2000';

const ActGallery = memo(
    ({ act, title, description, images, isRight = false }) => {
        ...
        return (
            <section className="py-24 lg:py-40 container mx-auto px-8 lg:px-32 overflow-hidden">
                <div
                    className={`flex flex-col lg:flex-row gap-16 lg:gap-24 items-end mb-20 ${isRight ? 'lg:flex-row-reverse' : ''}`}
                >
                    <motion.div
                        variants={fadeUp}
                        initial="hidden"
                    ...
                    >
                        <div
                            className={`flex items-center gap-4 mb-8 ${isRight ? 'lg:flex-row-reverse' : ''}`}
                        >
                            <span className="font-serif italic text-xl text-attire-accent opacity-50">
                                {act.split(' ')[1]}
                            </span>
                            <div
                                className={`h-px flex-1 bg-gradient-to-r ${isRight ? 'lg:from-transparent lg:to-attire-accent/20 from-attire-accent/20 to-transparent' : 'from-attire-accent/20 to-transparent'}`}
                            />
                        </div>
                        <h3
                            className="font-serif text-4xl md:text-6xl lg:text-7xl mb-10 tracking-tighter leading-[0.9] italic"
                            dangerouslySetInnerHTML={{ __html: title }}
                        />
                        <div
                            className={`flex gap-8 items-start ${isRight ? 'lg:flex-row-reverse' : ''}`}
                        >
                    ...
                    <div
                        className={`lg:w-1/2 flex flex-col gap-3 ${isRight ? 'lg:items-start' : 'lg:items-end'}`}
                    >
                        <span className="text-[9px] uppercase tracking-[0.6em] text-white/20 font-bold">
                            Showcase Portfolio
                        </span>
                        <div className="flex gap-1.5">
                            {[1, 2, 3].map((i) => (
                                <Star
                                    key={i}
                                    size={7}
                                    className="text-attire-accent opacity-20"
                                />
                            ))}
                        </div>
                    </div>
                ...
                <div className="relative group overflow-visible">
                    {/* Navigation Arrows ✨ */}
                    <div className="absolute inset-y-0 -left-4 lg:-left-14 z-20 flex items-center">
                        <button
            ...
            "
                    ...
                    <div className="absolute inset-y-0 -right-4 lg:-right-14 z-20 flex items-center">
                        <button
            ...
            "
                    ...
                    <div className="flex items-center justify-center gap-4 opacity-20 mt-4">
                        ...
                        <span className="text-[8px] uppercase tracking-[0.5em] font-bold italic">
                            Explore Act
                        </span>
...
const PrestigeLogo = () => (
    <div className="flex items-baseline gap-1 select-none">
        <span className="font-serif text-xl tracking-[0.2em] font-light text-white">
            PRESTIGE
        </span>
...
const FashionShowPage = () => {
    ...
    const act1Images = useMemo(
        () =>
            Array.from(
                { length: 11 },
                (_, i) => `${minioBaseUrl}/uploads/WALK_1/walk1_${i + 1}.webp`
            ),
        []
    );

    const act2Images = useMemo(
        () =>
            Array.from(
                { length: 11 },
                (_, i) => `${minioBaseUrl}/uploads/WALK_2/walk2_${i + 1}.webp`
            ),
        []
    );

    const heroImage =
        'https://images.prestigeonline.com/wp-content/uploads/sites/9/2026/02/02140813/Z629270-1353x900.jpg';
    const logo =
        'https://www.prestigeonline.com/wp-content/themes/prestige/assets/images/logo.png';
    ...
    return (
        <div className="bg-[#0d3542] text-white min-h-screen selection:bg-attire-accent selection:text-white font-sans leading-relaxed overflow-x-hidden">
            ...
            <section className="relative h-screen flex items-center justify-center text-center overflow-hidden">
                <div className="absolute inset-0 z-0">
                    <motion.img
                        ...
                        src={heroImage}
                        alt="Hero"
                        className="w-full h-full object-cover opacity-40 lg:opacity-30"
                    />
                ...
                <div className="relative z-10 px-6 max-w-6xl mx-auto">
                    ...
                    >
                        <span className="text-[9px] tracking-[1.2em] uppercase text-attire-accent font-bold mb-10 block opacity-80">
                            Vol. 01 • The Inaugural Showcase
                        </span>
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16 text-[9px] tracking-[0.4em] uppercase text-white/40 font-bold border-t border-white/5 pt-12">
                            {[
                                { Icon: MapPin, text: 'Rosewood PP' },
                                { Icon: Users, text: '68 Guests' },
                                { Icon: Calendar, text: 'Feb 2025' },
                            ].map(({ Icon, text }, i) => (
                                <span
                                    key={i}
                                    className="flex items-center gap-2.5 transition-colors hover:text-attire-accent duration-500"
                                >
                                    <Icon
                                        size={10}
            ...
            <ActGallery
                act="Act I"
                title="Shades of <br/> Elegance"
                description="Formal elegance for gentlemen has typically been confined to the safety of black or midnight blue. Through ACT I, we chose to show you that gentlemen’s wardrobes can be as vibrant as their ambitions. We wanted to showcase how soft-textured accessories and subtle color hues can elevate formal, elegant attire for Cambodian gentlemen."
                images={act1Images}
            />
            <ActGallery
                act="Act II"
                title="Street <br/> Sartorial"
                description="The word ‘sartorial’ traditionally refers to refined, elegant menswear. We placed ‘street’ before it because elegance should have room to bend. It should allow space for self-expression, mixing and matching, whether it’s a quality piece from Attire Lounge Official, something thrifted, or even something borrowed from your family’s closet"
                images={act2Images}
                isRight={true}
            />
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-24 lg:gap-12 items-center">
                        ...
                        >
                            <div className="mb-16 flex flex-col items-start">
                                ...
                                <div className="flex items-center gap-4">
                                    <span className="text-[10px] uppercase tracking-[0.6em] text-attire-accent font-bold">
                                        Featured In
                                    </span>
                            ...
                            <h2 className="font-serif text-4xl md:text-6xl italic text-white/90 leading-[1.1] mb-12 tracking-tighter">
                                &ldquo;Fit, edit, and courage converge to
                                inspire{' '}
                                <span className="text-attire-accent">
                                    new possibilities.
                                </span>
                                &rdquo;
                            </h2>
                            ...
                            >
                                ...
                                <div className="flex flex-col">
                                    <span className="text-[10px] uppercase tracking-[0.4em] font-bold text-white/40 group-hover:text-white transition-colors mb-1">
                                        Press Release
                                    </span>
                                    <span className="text-[11px] text-white/20 font-light border-b border-white/5 group-hover:border-attire-accent transition-colors">
                                        View Full Article
                                    </span>
                                </div>
                            </a>
                        ...
                        >
                            <div className="relative p-12 lg:p-20 bg-white/[0.02] border border-white/5 backdrop-blur-xl shadow-2xl">
                                ...
                                <div className="mb-12">
                                    <span className="text-[9px] tracking-[0.8em] uppercase text-white/20 mb-2 block font-bold">
                                        The Experience
                                    </span>
                                    <div className="flex gap-1.5">
                                        {[1, 2, 3].map((i) => (
                                            <Star
                                                key={i}
                                                size={8}
                                                className="text-attire-accent/30"
                                                fill="currentColor"
                                            />
                                        ))}
                                    </div>
                                ...
                                <h3 className="font-serif text-4xl lg:text-5xl italic font-light mb-12 tracking-tighter leading-none text-white">
                                    Define Your <br />{' '}
                                    <span className="text-attire-accent opacity-80">
                                        Own
                                    </span>{' '}
                                    Standard
                                </h3>
                                ...
                                <p className="text-white/40 text-sm font-light leading-relaxed mb-16 max-w-xs">
                                    Experience the pinnacle of styling
                                    excellence. Join us for a private
                                    consultation in our Phnom Penh atelier.
                                </p>
                                ...
                                >
                                    <span className="text-[12px] uppercase tracking-[0.6em] font-bold text-white group-hover:text-attire-accent transition-colors">
                                        Book Now
                                    </span>
                                    <div className="flex items-center gap-4">
                                        <span className="text-[9px] uppercase tracking-[0.2em] text-white/20 group-hover:text-white/40 transition-colors">
                                            Consultation
                                        </span>
                                        <ArrowRight
                                            size={20}
                                            className="text-attire-accent transform group-hover:translate-x-4 transition-transform duration-700 ease-out"
                                        />
                                    </div>
                                </a>
                            </div>
