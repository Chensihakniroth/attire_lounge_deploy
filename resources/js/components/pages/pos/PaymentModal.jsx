...
const PaymentModal = ({ totals, onClose }) => {
    ...
    const handleCheckout = async () => {
        ...
        try {
            ...
            // Wait a bit to show success before clearing and closing
            setTimeout(() => {
                clearInvoice();
                onClose();
            }, 3000);
        ...
        return (
            ...
            >
                <motion.div 
                    ...
                    animate={{ scale: 1, y: 0 }}
                    className="text-center space-y-6 max-w-md p-10 bg-white dark:bg-[#0a0a0a] rounded-[3rem] border border-attire-accent/30 shadow-[0_0_100px_rgba(212,175,55,0.2)]"
                >
                    ...
                    <div className="space-y-2">
                        <h2 className="text-2xl font-bold uppercase tracking-[0.3em] text-gray-900 dark:text-white">Sale Successful</h2>
                    ...
                    <div className="pt-4">
                        <button 
                            onClick={onClose}
                            className="px-8 py-3 bg-black dark:bg-white/10 text-white dark:text-attire-accent text-[10px] font-bold uppercase tracking-widest rounded-xl hover:scale-105 transition-all active:scale-95 border border-black/10 dark:border-white/10"
                        >
                            Close Terminal
                        </button>
                    </div>
    ...
    return (
        ...
        >
            <motion.div 
                ...
                className="w-full max-w-4xl bg-white dark:bg-[#0a0a0a] rounded-[2.5rem] shadow-2xl border border-black/5 dark:border-white/10 overflow-hidden flex flex-col md:flex-row max-h-[90vh]"
            ...
            >
                            ...
                            <button
                                ...
                                className={`flex flex-col items-center justify-center gap-3 p-5 rounded-2xl border transition-all ${
                                    currentMethod === method.name 
                                        ...
                                        : 'bg-black/[0.02] dark:bg-white/[0.02] border-black/5 dark:border-white/5 text-gray-400 hover:border-attire-accent/30'
                                }`}
                            >
                                {method.icon}
                    ...
                    <div className="space-y-6 mt-auto">
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                ...
                                <button 
                                    onClick={addPayment}
                                    className="absolute right-4 top-1/2 -translate-y-1/2 px-6 py-3 bg-black dark:bg-white/10 text-white dark:text-attire-accent text-[9px] font-bold uppercase tracking-widest rounded-xl hover:bg-attire-accent hover:text-black transition-all shadow-lg"
                                >
                                    Add Payment
                                </button>
                            </div>
                ...
                <div className="w-full md:w-[350px] p-8 bg-black/[0.02] dark:bg-white/[0.02] flex flex-col border-l border-black/5 dark:border-white/10">
