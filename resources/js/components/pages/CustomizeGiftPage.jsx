...
const SelectionCard = ({ item, isSelected, onSelect, isOutOfStock }) => {
    return (
        <div
            ...
            className={`relative group cursor-pointer ${isOutOfStock ? 'opacity-30 grayscale' : ''} transition-transform duration-500 hover:-translate-y-2`}
        >
            <div className={`aspect-[3/4] rounded-2xl overflow-hidden transition-all duration-700 border-2 ${
                ...
                {isSelected && (
                    <div className="absolute inset-0 bg-attire-accent/5" />
                )}
            ...
            {isSelected && (
                <div className="absolute -top-2 -right-2 w-8 h-8 bg-attire-accent text-black rounded-full flex items-center justify-center shadow-2xl border-4 border-attire-navy">
...
const CustomInput = ({ label, icon: Icon, error, ...props }) => (
    <div className="space-y-2">
        ...
        <div className="relative group">
            ...
            <input 
                {...props}
                className={`w-full bg-white/[0.03] border ${error ? 'border-red-500/30' : 'border-white/10'} hover:border-white/20 focus:border-attire-accent/50 focus:bg-white/[0.05] rounded-2xl py-5 pl-14 pr-6 text-white text-sm outline-none transition-all duration-500`}
            />
        </div>
    </div>
);
...
const CustomizeGiftPage = () => {
    ...
    return (
        <div className="min-h-screen bg-attire-navy text-white selection:bg-attire-accent selection:text-black overflow-x-hidden">
            <div className="relative z-10 max-w-[1400px] mx-auto px-6 py-28 sm:py-40">
                <header className="max-w-3xl mx-auto text-center mb-24">
                    <div className="inline-flex items-center gap-4 px-6 py-2 rounded-full border border-white/10 bg-white/[0.03] mb-10">
                    ...
                    <h1 className="text-6xl md:text-8xl font-serif font-light text-white mb-8 leading-none">
                ...
                <div ref={contentRef} className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start min-h-[120vh] pb-32">
                    <div className="lg:col-span-7 xl:col-span-8">
                        <Fragment>
                            ...
                            {step === 3 && (
                                <div className="space-y-12 bg-white/[0.03] border border-white/10 p-12 rounded-[2.5rem] relative overflow-hidden">
                                    <button 
                                        onClick={() => setStep(2)}
                            ...
                            {step === 4 && (
                                <div className="text-center space-y-12 py-20">
                                    <div className="w-32 h-32 bg-attire-accent/10 rounded-full flex items-center justify-center mx-auto border border-attire-accent/20">
                    ...
                    <div className="lg:col-span-5 xl:col-span-4 sticky top-40 space-y-8 hidden lg:block">
                        <div className="bg-white/[0.03] border border-white/10 p-10 rounded-[2.5rem] space-y-10">
                            <div className="flex items-center justify-between border-b border-white/10 pb-8">
