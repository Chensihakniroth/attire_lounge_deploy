        ...
        <div className="min-h-screen bg-attire-navy relative overflow-hidden">
            <div className="relative z-10 pt-32 pb-24 px-4 sm:px-6 lg:px-8">
                <div className="max-w-4xl mx-auto">
                    {/* Breadcrumbs */}
                    <div className="flex items-center gap-2 text-xs text-attire-silver/50 uppercase tracking-widest mb-12 font-medium">
                    ...
                    <div className="relative">
                        <div className="relative bg-[#0a0f1a] border border-white/10 rounded-[2rem] p-8 md:p-16 shadow-2xl overflow-hidden">
                            {/* Decorative Line */}
