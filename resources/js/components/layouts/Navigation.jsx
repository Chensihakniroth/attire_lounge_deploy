...
const Navigation = () => {
    ...
    useEffect(() => {
        const handler = ({ detail }) =>
            setIsLookbookFilterOpen(detail.isFilterOpen);
        window.addEventListener('lookbookFilterStateChange', handler);
        return () =>
            window.removeEventListener('lookbookFilterStateChange', handler);
    }, []);
    ...
    const navIconColor =
        'text-white transition-colors duration-300 hover:text-attire-accent';
                    ...
                    <>
                        ...
                        >
                            ...
                            <div className="p-8 flex items-center justify-between">
                                <span className="font-serif text-xl text-white tracking-[0.2em] uppercase">
                                    Menu
                                </span>
                                <button
                                    onClick={() => setIsMenuOpen(false)}
